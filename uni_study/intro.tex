...
The Urban Neighborhood Initiative, its constituent neighborhoods, and the community at large
 to make an informed decision about 
cooperating on a `free network' in the core of Kansas City.\par
...
of extending the KCFN to the core, propose a plan for doing so, and give estimates
of cost.\par
Our finding is that the corridor in question is fertile with opportunities
for network growth. To successfully seed network growth, UNI and UNI partners
would do well to support operator training programs aimed at establishing
a corps of community technologists.\par
\end{abstract}
...
expand and improve the network. The skills to do so are attainable, but
...
\begin{center}
\fbox{\includegraphics[width=3.75in]{es_toner_labelled.png}}
\fbox{\includegraphics[width=5in]{Diagram1.png}}
\end{center}
...
In addition to these existing sites, two additional towers are slated to be brought
online in the near future:
\begin{description}
\item[Lincoln Prep] Lincoln Prep, because of its commanding vista, appropriate architecture,
and historical significance, will be a key site in the KCFN. After months of preparation,
construction at the site is slated to begin in February. \par
{\bf Technical Details:} Multiple hold-off mounts will be used to mount two NanoBridge M5's,
and a Unifi Outdoor radio above the cafeteria. Routing and switching gear will be located
in an adjacent mechanical closet.

\item[Mary L. Kelly Center] The Upper Room Program is currently seeking funding to improve
and extend the KCFN backbone from Oak Tower to 3101 Troost, and from 3101 Troost to the Kelly
Center at 51\textsuperscript{st} \& South Benton. Access and education for the surrounding
communities are paramount concerns. \par
{\bf Technical Details:} Unlike most links in KCFN, the proposed backbone would use 24GHz radios,
achieving speeds in excess of one gigabit per second. 
\end{description}
