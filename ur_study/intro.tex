...
The Upper Room, and other prospective participants to make an informed decision about 
cooperating on a `free network' in the Swope Corridor.\par
...
of extending the KCFN to the Swope Corridor area, propose a plan for doing so, and give estimates
of cost.\par
Our finding is that launching such a network is certainly feasible, and would provide significant
 benefits to The Upper Room and its constituents, neighborhood residents and businesses, and the 
...
\begin{center}
\fbox{\includegraphics[width=3in]{es_toner_labelled.png}}
